...
public open class ShowApi(api: GenericSpotifyApi) : SpotifyEndpoint(api) {
     ...
     * @return possibly-null Show. This behavior is *not the same* as in [getShows]
     */
    public fun getShowRestAction(id: String, market: Market): SpotifyRestAction<Show?> =
        SpotifyRestAction { getShow(id, market) }
     ...
     * @throws BadRequestException If any invalid show id is provided
     */
    public fun getShowsRestAction(vararg ids: String, market: Market): SpotifyRestAction<List<SimpleShow?>> =
        SpotifyRestAction {
            getShows(*ids, market = market)
        }
    ...
    public fun getShowEpisodesRestAction(
        ...
        offset: Int? = null,
        market: Market
    ): SpotifyRestAction<PagingObject<SimpleEpisode>> = SpotifyRestAction {
        getShowEpisodes(id, limit, offset, market)
    }
}
