...
interface ISpotifyClientApiBuilder : ISpotifyApiBuilder {
     ...
     */
    fun buildAsync(consumer: (SpotifyClientAPI) -> Unit)
...
class SpotifyClientApiBuilder(
    ...
    override fun buildAsync(consumer: (SpotifyClientAPI) -> Unit) = Thread { consumer(build()) }.start()
}
...
interface ISpotifyAppApiBuilder : ISpotifyApiBuilder {
     ...
     */
    fun buildAsync(consumer: (SpotifyAPI) -> Unit)
...
class SpotifyAppApiBuilder(
     ...
     */
    override fun buildAsync(consumer: (SpotifyAPI) -> Unit) = Thread { consumer(build()) }.start()
